...
- **AI-elemzés**: ~95 magyarázható réteg — események (gól/lövés/passz/
  ...
  eladás-időzítés, pressz-tűrés.
  Minden réteg magyar edzői nyelven indokol.
- **Felderítés és tervezés**: több-meccses ellenfél-profil pontos
  (count-alapú) összegzéssel, edzői kulcsok, meccsterv-illesztés (59 páros
  szabály), fejlődés-követés trenddel, edzés-fókusz (80 szabály,
...
- **Minőség**: 745+ automata teszt; pontosság-validáció kézi eseménylista
