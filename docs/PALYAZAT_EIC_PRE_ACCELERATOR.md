...
- **288 elemző réteg** és **1180 automata teszt** — mérhető, verziók
  közt összevethető minőség ("kevés minta → nincs ítélet" elv).
