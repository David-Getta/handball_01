...
- **288 analysis layers** across attack, defence, goalkeeping, rules,
  momentum and physical load; **1,180 automated tests** and a
  reproducible benchmark guard the quality of every release.
