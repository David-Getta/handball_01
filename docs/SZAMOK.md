...
| Automata teszt | **1716** | `def test_*` függvények a `backend/tests/`-ben |
| Meccsterv-szabály | **432** | a legnagyobb sorszámozott szabály a `pipeline/scouting.py`-ban |
| Edzés-szabály | **452** | a legnagyobb sorszámozott szabály a `pipeline/training.py`-ban |
