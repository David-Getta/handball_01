...
|---|---:|---|
| Elemző réteg (meccs-csomag) | **448** | `_layer("...")` regisztrációk az `api/app.py`-ban |
| Automata teszt | **1622** | `def test_*` függvények a `backend/tests/`-ben |
...
| Kliens-csempe (felderítés) | **421** | csempe-sorok a `client/lib/ui/scouting_screen.dart`-ban |
