...
def create_app():
    ...
    def _attacks_payload(match):
        ...
        try:
            ...
            res["role_shot_distance"] = role_shot_distance(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["role_shot_power"] = role_shot_power(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.attack_types import shot_ranges
            res["shot_ranges"] = shot_ranges(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["wing_finishing"] = wing_finishing(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import pass_direction
            res["pass_direction"] = pass_direction(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import assist_sources
            res["assist_sources"] = assist_sources(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["blocked_shot_rate"] = blocked_shot_rate(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import steal_height
            res["steal_height"] = steal_height(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["shot_timing"] = shot_timing(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["turnover_fade"] = turnover_fade(match)
        except Exception:
            pass
        try:
            from ..pipeline.goalkeeper import gk_save_fade
            res["gk_save_fade"] = gk_save_fade(match)
        except Exception:
            pass
        try:
            from ..pipeline.momentum import lead_protection
            res["lead_protection"] = lead_protection(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["close_game_record"] = close_game_record(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["gk_change_effect"] = gk_change_effect(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["run_containment"] = run_containment(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["shot_concentration"] = shot_concentration(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.defense import turnover_timing
            res["turnover_timing"] = turnover_timing(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["turnover_punishment"] = turnover_punishment(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.momentum import drought_anatomy
            res["drought_anatomy"] = drought_anatomy(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import wall_gaps
            res["wall_gaps"] = wall_gaps(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.goalkeeper import gk_outlet_security
            res["gk_outlet_security"] = gk_outlet_security(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import pivot_defense
            res["pivot_defense"] = pivot_defense(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["restart_speed"] = restart_speed(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["goal_buildup"] = goal_buildup(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["side_switching"] = side_switching(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.defense import screen_defense
            res["screen_defense"] = screen_defense(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import pass_risk
            res["pass_risk"] = pass_risk(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["counter_press"] = counter_press(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.momentum import clutch_turnovers
            res["clutch_turnovers"] = clutch_turnovers(match)
        except Exception:
            pass
        try:
            from ..pipeline.goalkeeper import gk_outlet_side
            res["gk_outlet_side"] = gk_outlet_side(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import double_teams
            res["double_teams"] = double_teams(match)
        except Exception:
            pass
        try:
            from ..pipeline.goalkeeper import gk_free_shot_saves
            res["gk_free_shot_saves"] = gk_free_shot_saves(match)
        except Exception:
            pass
        try:
            from ..pipeline.rules import powerplay_defense
            res["powerplay_defense"] = powerplay_defense(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["wing_defense"] = wing_defense(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["shooter_power"] = shooter_power(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.defense import targeted_defenders
            res["targeted_defenders"] = targeted_defenders(match)
        except Exception:
            pass
        try:
            from ..pipeline.tactics import formation_switching
            res["formation_switching"] = formation_switching(match)
        except Exception:
            pass
        try:
            from ..pipeline.decisions import hold_time_players
            res["hold_time_players"] = hold_time_players(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.stats import pair_plus_minus
            res["pair_plus_minus"] = pair_plus_minus(match)
        except Exception:
            pass
        try:
            from ..pipeline.stoppages import timeout_timing
            res["timeout_timing"] = timeout_timing(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import attack_starters
            res["attack_starters"] = attack_starters(match)
        except Exception:
            pass
        try:
            from ..pipeline.event_detection import assist_zones
            res["assist_zones"] = assist_zones(match)
        except Exception:
            pass
        try:
            from ..pipeline.roles import goals_by_role
            res["goals_by_role"] = goals_by_role(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import conceded_by_role
            res["conceded_by_role"] = conceded_by_role(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import turnover_clusters
            res["turnover_clusters"] = turnover_clusters(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["line_height_by_score"] = line_height_by_score(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import wing_involvement
            res["wing_involvement"] = wing_involvement(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["seven_meter_conceders"] = seven_meter_conceders(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["defensive_shift_lag"] = defensive_shift_lag(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.attack_types import wing_finishing_by_side
            res["wing_finishing_by_side"] = wing_finishing_by_side(match)
        except Exception:
            pass
        try:
            from ..pipeline.tactics import static_attackers
            res["static_attackers"] = static_attackers(match)
        except Exception:
            pass
        try:
            from ..pipeline.goalkeeper import gk_saves_by_speed
            res["gk_saves_by_speed"] = gk_saves_by_speed(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import recovery_discipline
            res["recovery_discipline"] = recovery_discipline(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import defensive_aggression
            res["defensive_aggression"] = defensive_aggression(match)
        except Exception:
            pass
        try:
            from ..pipeline.stoppages import playing_time_profile
            res["playing_time"] = playing_time_profile(match)
        except Exception:
            pass
        try:
            from ..pipeline.rules import powerplay_pace
            res["powerplay_pace"] = powerplay_pace(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["shooter_ranges"] = shooter_ranges(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["buildup_side"] = buildup_side(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["shot_distance_fade"] = shot_distance_fade(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.momentum import opening_lineup
            res["opening_lineup"] = opening_lineup(match)
        except Exception:
            pass
        try:
            from ..pipeline.xg import wasteful_shooters
            res["wasteful_shooters"] = wasteful_shooters(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.decisions import pressure_sensitive_players
            res["pressure_sensitive_players"] = (
                pressure_sensitive_players(match))
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.goalkeeper import keeper_involvement
            res["keeper_involvement"] = keeper_involvement(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import buildup_time
            res["buildup_time"] = buildup_time(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import press_after_goal
            res["press_after_goal"] = press_after_goal(match)
        except Exception:
            pass
        try:
            from ..pipeline.stoppages import timeout_first_defense
            res["timeout_first_defense"] = timeout_first_defense(match)
        except Exception:
            pass
        try:
            from ..pipeline.momentum import half_openings
            res["half_openings"] = half_openings(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import fast_break_conversion
            res["fast_break_conversion"] = fast_break_conversion(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["steal_types"] = steal_types(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["sevens_fade"] = sevens_fade(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["pullback_rate"] = pullback_rate(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.defense import advanced_defender
            res["advanced_defender"] = advanced_defender(match)
        except Exception:
            pass
        try:
            from ..pipeline.goalkeeper import seven_keeper_swaps
            res["seven_keeper_swaps"] = seven_keeper_swaps(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.stats import distance_battle
            res["distance_battle"] = distance_battle(match)
        except Exception:
            pass
        try:
            from ..pipeline.roles import turnovers_by_role
            res["turnovers_by_role"] = turnovers_by_role(match)
        except Exception:
            pass
        try:
            from ..pipeline.rules import post_powerplay
            res["post_powerplay"] = post_powerplay(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["gk_saves_by_score"] = gk_saves_by_score(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["pivot_guards"] = pivot_guards(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["setplay_shapes"] = setplay_shapes(match)
        except Exception:
            pass
        try:
            from ..pipeline.setplays import figure_vs_formation
            res["figure_vs_formation"] = figure_vs_formation(match)
        except Exception:
            pass
        try:
            from ..pipeline.setplays import setplay_repeat_choice
            res["setplay_repeat_choice"] = setplay_repeat_choice(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.setplays import powerplay_setplay
            res["powerplay_setplay"] = powerplay_setplay(match)
        except Exception:
            pass
        try:
            from ..pipeline.setplays import clutch_setplay
            res["clutch_setplay"] = clutch_setplay(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.setplays import empty_net_setplay
            res["empty_net_setplay"] = empty_net_setplay(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.goalkeeper import gk_goal_threat
            res["gk_goal_threat"] = gk_goal_threat(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import break_sources
            res["break_sources"] = break_sources(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import attack_vs_wall_height
            res["attack_vs_wall_height"] = (
                attack_vs_wall_height(match))
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.momentum import drought_breakers
            res["drought_breakers"] = drought_breakers(match)
        except Exception:
            pass
        try:
            from ..pipeline.defense import wing_closeouts
            res["wing_closeouts"] = wing_closeouts(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import screen_pairs
            res["screen_pairs"] = screen_pairs(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["big_chance_finishers"] = big_chance_finishers(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.attack_types import attack_headcount
            res["attack_headcount"] = attack_headcount(match)
        except Exception:
            pass
        try:
            from ..pipeline.attack_types import long_attack_outcomes
            res["long_attack_outcomes"] = (
                long_attack_outcomes(match))
        except Exception:
            pass
        try:
            from ..pipeline.goalkeeper import gk_rebound_control
            res["gk_rebound_control"] = gk_rebound_control(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["wing_service"] = wing_service(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["fast_break_waves"] = fast_break_waves(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.defense import blocked_shooters
            res["blocked_shooters"] = blocked_shooters(match)
        except Exception:
            pass
        try:
            from ..pipeline.roles import assists_by_role
            res["assists_by_role"] = assists_by_role(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["doubling_defenders"] = doubling_defenders(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["reading_keeper"] = reading_keeper(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["stepout_punishment"] = stepout_punishment(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["outlet_punishment"] = outlet_punishment(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["suspensions_by_score"] = suspensions_by_score(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["pass_direction_by_score"] = pass_direction_by_score(match)
        except Exception:
            pass
        try:
            ...
            pass
        try:
            from ..pipeline.event_detection import pass_length_by_score
            res["pass_length_by_score"] = pass_length_by_score(match)
        except Exception:
            pass
        try:
            from ..pipeline.tactics import defense_form_shift
            res["defense_form_shift"] = defense_form_shift(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            res["sprints_by_score"] = sprints_by_score(match)
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            from ..pipeline.xg import defense_by_score
            res["defense_by_score"] = defense_by_score(match)
        except Exception:
            pass
        try:
            from ..pipeline.substitutions import subs_by_score
            res["subs_by_score"] = subs_by_score(match)
        except Exception:
            pass
        try:
    ...
    def start_package_export(match_id: str, body: dict):
        ...
        def _work():
            ...
            try:
                ...
                from ..pipeline.attack_types import wing_finishing
                _layer("wing_finishing", lambda: wing_finishing(match))
                from ..pipeline.defense import defensive_line_height
                _layer("defensive_line_height",
                       lambda: defensive_line_height(match))
                from ..pipeline.attack_types import pass_direction
                ...
                from ..pipeline.defense import turnover_fade
                _layer("turnover_fade", lambda: turnover_fade(match))
                from ..pipeline.goalkeeper import gk_save_fade
                ...
                from ..pipeline.defense import turnover_timing
                _layer("turnover_timing",
                       lambda: turnover_timing(match))
                from ..pipeline.decisions import \
                ...
                from ..pipeline.momentum import clutch_turnovers
                _layer("clutch_turnovers",
                       lambda: clutch_turnovers(match))
                from ..pipeline.goalkeeper import gk_outlet_side
                _layer("gk_outlet_side", lambda: gk_outlet_side(match))
                from ..pipeline.defense import double_teams
                _layer("double_teams", lambda: double_teams(match))
                from ..pipeline.goalkeeper import gk_free_shot_saves
                _layer("gk_free_shot_saves",
                       lambda: gk_free_shot_saves(match))
                from ..pipeline.rules import powerplay_defense
                ...
                from ..pipeline.defense import targeted_defenders
                _layer("targeted_defenders",
                       lambda: targeted_defenders(match))
                from ..pipeline.tactics import formation_switching
                _layer("formation_switching",
                       lambda: formation_switching(match))
                from ..pipeline.decisions import hold_time_players
                ...
                from ..pipeline.stats import pair_plus_minus
                _layer("pair_plus_minus", lambda: pair_plus_minus(match))
                from ..pipeline.stoppages import timeout_timing
                _layer("timeout_timing", lambda: timeout_timing(match))
                from ..pipeline.attack_types import attack_starters
                _layer("attack_starters", lambda: attack_starters(match))
                from ..pipeline.event_detection import assist_zones
                _layer("assist_zones", lambda: assist_zones(match))
                from ..pipeline.roles import goals_by_role
                _layer("goals_by_role", lambda: goals_by_role(match))
                from ..pipeline.defense import conceded_by_role
                _layer("conceded_by_role", lambda: conceded_by_role(match))
                from ..pipeline.defense import turnover_clusters
                ...
                from ..pipeline.defense import line_height_by_score
                _layer("line_height_by_score",
                       lambda: line_height_by_score(match))
                from ..pipeline.attack_types import wing_involvement
                ...
                _layer("wing_finishing_by_side",
                       lambda: wing_finishing_by_side(match))
                from ..pipeline.tactics import static_attackers
                _layer("static_attackers",
                       lambda: static_attackers(match))
                from ..pipeline.goalkeeper import gk_saves_by_speed
                _layer("gk_saves_by_speed",
                       lambda: gk_saves_by_speed(match))
                from ..pipeline.defense import recovery_discipline
                _layer("recovery_discipline",
                       lambda: recovery_discipline(match))
                from ..pipeline.defense import defensive_aggression
                _layer("defensive_aggression",
                       lambda: defensive_aggression(match))
                from ..pipeline.stoppages import playing_time_profile
                _layer("playing_time",
                ...
                from ..pipeline.momentum import opening_lineup
                _layer("opening_lineup", lambda: opening_lineup(match))
                from ..pipeline.xg import wasteful_shooters
                ...
                from ..pipeline.goalkeeper import keeper_involvement
                _layer("keeper_involvement",
                       lambda: keeper_involvement(match))
                from ..pipeline.attack_types import buildup_time
                _layer("buildup_time", lambda: buildup_time(match))
                from ..pipeline.defense import press_after_goal
                _layer("press_after_goal",
                       lambda: press_after_goal(match))
                from ..pipeline.stoppages import (
                    timeout_first_defense)
                _layer("timeout_first_defense",
                       lambda: timeout_first_defense(match))
                from ..pipeline.momentum import half_openings
                _layer("half_openings", lambda: half_openings(match))
                from ..pipeline.attack_types import (
                ...
                from ..pipeline.defense import advanced_defender
                _layer("advanced_defender",
                       lambda: advanced_defender(match))
                from ..pipeline.goalkeeper import seven_keeper_swaps
                ...
                from ..pipeline.stats import distance_battle
                _layer("distance_battle",
                       lambda: distance_battle(match))
                from ..pipeline.roles import turnovers_by_role
                _layer("turnovers_by_role",
                       lambda: turnovers_by_role(match))
                from ..pipeline.rules import post_powerplay
                ...
                from ..pipeline.goalkeeper import gk_goal_threat
                _layer("gk_goal_threat",
                       lambda: gk_goal_threat(match))
                from ..pipeline.attack_types import break_sources
                _layer("break_sources",
                       lambda: break_sources(match))
                from ..pipeline.attack_types import (
                ...
                from ..pipeline.momentum import drought_breakers
                _layer("drought_breakers",
                       lambda: drought_breakers(match))
                from ..pipeline.defense import wing_closeouts
                _layer("wing_closeouts",
                ...
                from ..pipeline.attack_types import attack_headcount
                _layer("attack_headcount",
                       lambda: attack_headcount(match))
                from ..pipeline.attack_types import (
                    long_attack_outcomes)
                _layer("long_attack_outcomes",
                       lambda: long_attack_outcomes(match))
                from ..pipeline.goalkeeper import gk_rebound_control
                ...
                from ..pipeline.defense import blocked_shooters
                _layer("blocked_shooters",
                       lambda: blocked_shooters(match))
                from ..pipeline.roles import assists_by_role
                ...
                from ..pipeline.event_detection import \
                    pass_length_by_score
                _layer("pass_length_by_score",
                       lambda: pass_length_by_score(match))
                from ..pipeline.tactics import defense_form_shift
                ...
                from ..pipeline.xg import defense_by_score
                _layer("defense_by_score",
                       lambda: defense_by_score(match))
                from ..pipeline.substitutions import subs_by_score
                ...
                from ..pipeline.setplays import setplay_shapes
                _layer("setplay_shapes", lambda: setplay_shapes(match))
                from ..pipeline.setplays import figure_vs_formation
                _layer("figure_vs_formation",
                       lambda: figure_vs_formation(match))
                from ..pipeline.setplays import setplay_repeat_choice
                ...
                from ..pipeline.setplays import empty_net_setplay
                _layer("empty_net_setplay",
                       lambda: empty_net_setplay(match))
                from ..pipeline.defense import defensive_rebound_roles
